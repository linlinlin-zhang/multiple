import { THINKING_FRAMEWORKS, META_DIRECTIVES, CONTEXT_BOUNDARY_DIRECTIVES, SOURCE_GROUNDING_DIRECTIVES, CANVAS_ARTIFACT_DIRECTIVES, jsonSchemaContract, xmlBlock } from './shared.js';
...
export function buildUrlAnalysisPrompt({ url, domain, pageText, lang = "zh", taskType = "general" }) {
  ...
  return [
    ...
    "",
    isEn ? "# Canvas Artifact Contract" : "# 画布产物契约",
    CANVAS_ARTIFACT_DIRECTIVES[isEn ? "en" : "zh"],
    "",
