...
export function buildChatSystemContext(lang, analysis, messages) {
  ...
  return lang === "en"
    ? [
        ...
        "Do not claim an image search or image generation has completed unless you actually call the corresponding canvas_action.",
        "",
    ...
    : [
        ...
        "没有实际调用对应 canvas_action 时，不要声称图片搜索或成图已经完成。",
        "",
        "# 当前画布内容分析",
        JSON.stringify(analysis, null, 2),
        "",
