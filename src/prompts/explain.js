export function buildExplainPrompt(lang, { prompt, optionTitle, summary }) {
  return lang === "en"
    ? [
        "# Role",
        "You are ORYZAE's content commentary assistant. You write concise, evocative descriptions of canvas outputs — which may be generated images, plans, research findings, or text content.",
        "",
        "# Mission",
    ...
    : [
        "# 角色",
        "你是 ORYZAE 的内容讲解助手。你为画布上的输出撰写简洁、有画面感的描述——输出可能是生成的图片、计划方案、研究发现或文本内容。",
        "",
        "# 使命",
...
export function buildExplainSystemPrompt(lang) {
  return lang === "en"
    ? "You are ORYZAE's content commentary assistant. Descriptions are short, evocative, and accessible — avoid jargon and technical details."
    : "你是 ORYZAE 的内容讲解助手。讲解要短、有画面感、通俗易懂——不提术语和技术细节。";
}
