...
function useSession(sessionId) {
  ...
  const [error, setError] = reactExports.useState(null);
  const fetchSession = reactExports.useCallback(async () => {
    if (!sessionId) {
      setSession(null);
      setError(null);
      return;
...
function buildAssetUrl(hash, kind) {
...
const dictionaries = {
  zh: {
    ...
    "settings.option.resolution": "视频分辨率",
    "settings.option.ratio": "视频比例",
    "settings.option.duration": "视频时长（秒）",
    "settings.option.imageModel": "图生视频模型",
    "settings.option.textModel": "文生视频模型",
    "settings.option.pollIntervalMs": "任务轮询间隔",
    "settings.option.pollAttempts": "任务轮询次数",
    ...
    "settings.hint.resolution": "HappyHorse 支持 720P 和 1080P；720P 通常更快。",
    "settings.hint.ratio": "文生视频使用该比例；图生视频会跟随首帧比例。",
    "settings.hint.duration": "HappyHorse 支持 3-15 秒。",
    "settings.hint.imageModel": "用于首帧图生视频，默认 happyhorse-1.0-i2v。",
    "settings.hint.textModel": "没有公网首帧 URL 时使用，默认 happyhorse-1.0-t2v。",
    "settings.hint.pollIntervalMs": "DashScope 视频任务为异步任务，建议 15000ms 左右。",
    "settings.hint.pollAttempts": "轮询总时长约等于间隔乘次数。",
  ...
  en: {
    ...
    "settings.option.resolution": "Video resolution",
    "settings.option.ratio": "Video ratio",
    "settings.option.duration": "Video duration (s)",
    "settings.option.imageModel": "Image-to-video model",
    "settings.option.textModel": "Text-to-video model",
    "settings.option.pollIntervalMs": "Task poll interval",
    "settings.option.pollAttempts": "Task poll attempts",
    ...
    "settings.hint.resolution": "HappyHorse supports 720P and 1080P; 720P is usually faster.",
    "settings.hint.ratio": "Used for text-to-video; image-to-video follows the first-frame ratio.",
    "settings.hint.duration": "HappyHorse supports 3-15 seconds.",
    "settings.hint.imageModel": "Used for first-frame image-to-video, default happyhorse-1.0-i2v.",
    "settings.hint.textModel": "Used when there is no public first-frame URL, default happyhorse-1.0-t2v.",
    "settings.hint.pollIntervalMs": "DashScope video generation is asynchronous; around 15000ms is recommended.",
    "settings.hint.pollAttempts": "Approximate total wait equals interval multiplied by attempts.",
    ...
    "settings.hint.maxCanvasCards": "Maximum final Deep Research cards placed on the canvas, up to 25.",
    "settings.hint.maxReferenceCards": "Number of selected references kept and shown by Deep Research.",
    "settings.hint.liveCanvasCards": "Maximum temporary canvas cards created while streaming research, up to 25.",
    ...
    "asset.generatedVideo": "Generated video",
    "asset.video": "Video",
...
function I18nProvider({ children, initialLang = "zh" }) {
  const [lang, setLangState] = reactExports.useState(initialLang);
  const setLang = reactExports.useCallback((next) => {
    setLangState(next);
  ...
  return reactExports.createElement(I18nContext.Provider, { value: { lang, t, setLang } }, children);
}
function useI18n() {
...
function NodeGraphThumbnail({ nodes, links }) {
  if (nodes.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:75:7", className: "w-full h-[240px] bg-cabinet-bg rounded-3xl border border-cabinet-border overflow-hidden flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:76:9", className: "text-sm text-cabinet-inkMuted", children: "No graph data" }) });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:95:5", className: "w-full h-[240px] bg-cabinet-bg rounded-3xl border border-cabinet-border overflow-hidden relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:96:7", width: "100%", height: "100%", viewBox, preserveAspectRatio: "xMidYMid meet", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:97:9", children: /* @__PURE__ */ jsxRuntimeExports.jsx("filter", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:98:11", id: "shadow", x: "-10%", y: "-10%", width: "120%", height: "120%", children: /* @__PURE__ */ jsxRuntimeExports.jsx("feDropShadow", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:99:13", dx: "1", dy: "2", stdDeviation: "2", floodColor: "#000000", floodOpacity: "0.12" }) }) }),
      links.map((link, index) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
            "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:119:13",
          ...
          `${link.id || `${link.fromNodeId}-${link.toNodeId}-${index}`}-shadow`
        );
      }),
      links.map((link, index) => {
        const fromNode = nodeMap.get(link.fromNodeId);
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:146:13", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
              "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:147:15",
              d: buildBezierPath(start, end),
              stroke: "#0070cc",
              strokeWidth: 2,
              fill: "none"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:153:15", cx: start.x, cy: start.y, r: 6, fill: "#ffffff", stroke: "#0070cc", strokeWidth: 2 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:154:15", cx: end.x, cy: end.y, r: 6, fill: "#ffffff", stroke: "#0070cc", strokeWidth: 2 })
        ] }, link.id || `${link.fromNodeId}-${link.toNodeId}-${index}`);
      }),
      nodes.map((node) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:169:13", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "rect",
            {
              "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:170:15",
              x: node.x,
              y: node.y,
              width: w,
              height: h,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "text",
            {
              "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:182:15",
              x: node.x + w / 2,
              y: node.y + h / 2,
              fontSize: 12,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "code-path": "src/components/cabinet/NodeGraphThumbnail.tsx:198:7", className: "absolute bottom-2 right-2 text-[11px] text-cabinet-inkMuted bg-cabinet-paper/90 px-3 py-1 rounded-full pointer-events-none", children: [
      nodes.length,
      " nodes · ",
      links.length,
      " links"
