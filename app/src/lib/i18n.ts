...
const dictionaries: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "share.create": "创建分享",
    "share.creating": "创建中...",
    "share.createFailed": "分享链接创建失败",
    "share.delete": "删除分享",
    "share.deleteFailed": "分享链接删除失败",
    "share.expires": "有效期",
    "share.expiry7": "7 天",
    "share.expiry30": "30 天",
    "share.expiry90": "90 天",
    "share.expiryNever": "永不过期",
    "share.links": "分享链接",
    "share.visits": "{count} 次访问",
    "share.lastAccessed": "最近访问",
    "share.sessionType": "会话",
    "share.imageType": "图片",
    "share.viewOnly": "只读视图",
    ...
    "history.hideSystem": "隐藏系统历史",
    "history.restore": "恢复显示",
    "history.restoreFailed": "恢复历史记录失败",
    "history.deleteConfirm": "确定要删除“{title}”吗？此操作无法撤销。",
    "history.deleteFailed": "历史记录删除失败",
    "history.import": "导入会话",
    "history.importFailed": "导入会话失败",
    "history.importPartialFailed": "部分会话导入失败",
    "history.importPreviewTitle": "即将导入这些会话",
    "history.importPreviewConfirm": "同名会话会自动重命名后导入。继续吗？",
    "history.importConflicts": "{count} 个冲突",
    "history.export": "导出",
    "history.exportPreviewLoading": "正在生成导出预览...",
    "history.exportPreviewStats": "{nodes} 节点 · {assets} 素材 · {chats} 对话 · 约 {size}",
    ...
    "library.retry": "重试",
    "library.delete": "删除",
    "library.hideSystem": "隐藏系统素材",
    "library.hideSystemHint": "系统素材不会被删除，只会从你的素材库中隐藏。",
    "library.restore": "恢复",
    "library.restoreFailed": "恢复失败",
    "library.download": "下载",
  ...
  en: {
    ...
    "share.createFailed": "Failed to create share link",
    "share.delete": "Delete share",
    "share.deleteFailed": "Failed to delete share link",
    "share.expires": "Expires",
    "share.expiry7": "7 days",
    "share.expiry30": "30 days",
    "share.expiry90": "90 days",
    "share.expiryNever": "Never expires",
    "share.links": "Share links",
    "share.visits": "{count} visits",
    "share.lastAccessed": "Last accessed",
    "share.sessionType": "Session",
    "share.imageType": "Image",
    ...
    "history.hideSystem": "Hide system history",
    "history.restore": "Restore",
    "history.restoreFailed": "Failed to restore history record",
    "history.deleteConfirm": "Delete \"{title}\"? This action cannot be undone.",
    "history.deleteFailed": "Failed to delete history record",
    "history.import": "Import sessions",
    "history.importFailed": "Failed to import sessions",
    "history.importPartialFailed": "Some sessions failed to import",
    "history.importPreviewTitle": "These sessions will be imported",
    "history.importPreviewConfirm": "Sessions with duplicate titles will be renamed automatically. Continue?",
    "history.importConflicts": "{count} conflicts",
    "history.export": "Export",
    "history.exportPreviewLoading": "Preparing export preview...",
    "history.exportPreviewStats": "{nodes} nodes · {assets} assets · {chats} chats · about {size}",
    ...
    "library.hideSystem": "Hide system material",
    "library.hideSystemHint": "System materials are hidden from your library instead of being deleted.",
    "library.restore": "Restore",
    "library.restoreFailed": "Restore failed",
