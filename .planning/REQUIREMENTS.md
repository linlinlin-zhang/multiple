...
- [ ] **INPT-02**: 支持上传网页链接，调用大模型 API 的网页搜索/摘要能力分析网站内容，生成创作方向；初始卡片展示网页截图或图标占位
...
- [ ] **TOOL-01**: 一键整理画布：使用算法自动收缩所有未成图节点，将剩余节点按树形或层级排布得更美观整洁
- [ ] **TOOL-02**: 图片查看弹窗：点击卡片中的图片时，弹出模态框放大展示图片及相关描述
- [ ] **TOOL-03**: 图片修改：在图片查看弹窗中加入「修改」按钮，点击后提供两个选项——一键自动重新生成，或在文本框中输入自定义修改 prompt
- [ ] **TOOL-04**: 图片下载：在图片查看弹窗中加入「下载」按钮，点击后下载原始图片文件
