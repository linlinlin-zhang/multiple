...
test("repair p with class", repairRenderedMarkdownHeadings, '<p class="x"># 光线与影调</p>', '<p class="x"># 光线与影调</p>');
test("repair p with nbsp entity", repairRenderedMarkdownHeadings, "<p>#&nbsp;光线与影调</p>", "<p>#&nbsp;光线与影调</p>");
test("repair p with br", repairRenderedMarkdownHeadings, "<p># 光线与影调<br>高对比</p>", "<p># 光线与影调<br>高对比</p>");
test("repair p with bold markdown", repairRenderedMarkdownHeadings, "<p># **光线与影调**：高对比</p>", "<h1>**光线与影调**：高对比</h1>");
test("repair p with span", repairRenderedMarkdownHeadings, "<p># <span>光线与影调</span></p>", "<p># <span>光线与影调</span></p>");
...
test("strip h2 with span child", stripRenderedHeadingMarkerPrefixes, "<h2><span># </span>光线与影调</h2>", "<h2><span># </span>光线与影调</h2>");
